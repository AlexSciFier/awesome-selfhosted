...
- [NeonLink](https://github.com/AlexSciFier/neonlink) - Self-hosted bookmark service with unique design and simple instalation with Docker. ([Source Code](https://github.com/AlexSciFier/neonlink)) `MIT` `Docker/Nodejs`
