...
- [NeonLink](https://github.com/AlexSciFier/neonlink) - A self-hosted bookmark service with unique design and simple docker install. ([Source Code](https://github.com/AlexSciFier/neonlink)) `MIT` `Docker/Nodejs`
